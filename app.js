...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className="task__button__delete__image";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("section__list__edit");
    ...
    listItem.classList.toggle("section__list__edit");
};
